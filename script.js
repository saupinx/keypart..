...
const translations = {
  ru: {
    ...
    hero: {
      title: 'IT аутсорсинг –<br>Ваш бизнес заслуживает<br>безупречной IT‑поддержки!',
    ...
    form: {
      ...
      phoneError: 'Укажите телефон в формате +7 (777) 123-45-67.',
  ...
  en: {
    ...
    hero: {
      title: 'IT outsourcing —<br>Your business deserves<br>flawless IT support!',
    ...
    businessBlocks: [
      ...
      ['Business infrastructure', 'Server deployment and support<br>Backup system implementation<br>Network security configuration<br>Building a unified corporate network for branches<br>Integration with online monitoring<br>Antivirus installation and updates<br>Seamless Wi‑Fi setup and configuration'],
    ...
    form: {
      ...
      phoneError: 'Enter a phone number in the format +7 (777) 123-45-67.',
...
function applyLanguage(lang, persist = false) {
  ...
  if (phoneInput) phoneInput.setAttribute('placeholder', locale.hero.phone);
